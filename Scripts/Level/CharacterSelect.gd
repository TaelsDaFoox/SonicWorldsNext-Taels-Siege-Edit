...
var characterLabels = ["Sonic and Tails", "Sonic", "Tails", "Knuckles", "Amy", "Knuckles and Knuckles", "Tails and Sonic", "Mighty", "Modern Sonic"]
...
enum CHARACTER_ID { SONIC_AND_TAILS, SONIC, TAILS, KNUCKLES, AMY, KNUX_AND_KNUX, TAILS_AND_SONIC, MIGHTY, MSONIC}
	...
	if !selected:
		...
		if event.is_action_pressed("gm_pause"):
			...
			match(characterID):
				...
				CHARACTER_ID.KNUX_AND_KNUX:
					Global.PlayerChar1 = Global.CHARACTERS.KNUCKLES
					Global.PlayerChar2 = Global.CHARACTERS.KNUCKLES
				CHARACTER_ID.TAILS_AND_SONIC:
					Global.PlayerChar1 = Global.CHARACTERS.TAILS
					Global.PlayerChar2 = Global.CHARACTERS.SONIC
				CHARACTER_ID.MIGHTY:
			...
			match(levelID):
				...
				2: #the cool option
					Global.nextZone = load("res://Scene/Zones/TaerusuZone.tscn")
				#2: # Chunk Zone Act 1
